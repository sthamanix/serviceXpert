                                        ...
                                        <div class="row contentbody">
                                            <div class="col-sm-6">
                                                <ul>
                                                    ...
                                                    <li><i class="fp-ht-food"></i>Wages : <?php echo number_format($result->SALARIES,2);  ?></li>
                                                    <!-- <li><i class="fa fa-sun-"></i>Duration of Employment : <?php echo $result->DURATION_EMPLOYEMENT; ?></li> -->
                                                </ul>
                                            </div>
                                            <div class="col-sm-6">
                                                <ul>
                                                     <!-- <li><i class="fp-ht-dumbbell"></i>Work Experience : <?php echo $result->QUALIFICATION_WORKEXPERIENCE; ?></li> -->
                                          ...
                                          <a href="<?php echo web_root; ?>index.php?q=apply&job=<?php echo $result->JOBID;?>&view=personalinfo" class="btn btn-main btn-next-tab">Book Now !</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
