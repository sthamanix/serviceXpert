...
?> 
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
            ...
            <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Add New Serviceman</h1>
          </div>
          <!-- /.col-lg-12 -->
       </div> 
                      ...
                      <div class="col-md-8">
                        ...
                        <input type="hidden" name="COMPANYID" value="<?php echo $res->COMPANYID ;?>">
                         <input class="form-control input-sm" id="COMPANYNAME" name="COMPANYNAME" placeholder=
                            " Name" type="text" value="<?php echo $res->COMPANYNAME ;?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS" placeholder=
                            " Address" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $res->COMPANYADDRESS ;?></textarea>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANYCONTACTNO">Contact No.:</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="COMPANYCONTACTNO" name="COMPANYCONTACTNO" placeholder=
                            "Contact No." type="text" value="<?php echo $res->COMPANYCONTACTNO ;?>">
                      </div>
                    </div>
                  </div>
