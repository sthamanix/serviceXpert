...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul>
            ...
            <li><i class="fp-ht-food"></i>Wages : <?php echo number_format($job->SALARIES,2);  ?></li>
...
<p><i class="fa fa-paperclip"></i>  Attachment Files</p>
	<div class="col-sm-12 slider">
		 <h3>Download Resume <a href="<?php echo web_root.'admin/applicants/photos/'.$attachmentfile->FILE_LOCATION; ?>">Here</a></h3>
	</div>  -->
