...
?>
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <h1 class="page-header">Add New Services</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                 </div> 
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="SALARIES" name="SALARIES" placeholder="Wages"   autocomplete="none"/> 
                      </div>
                    </div>
                  </div>  
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "QUALIFICATION_WORKEXPERIENCE">Work Experience:</label> 
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="QUALIFICATION_WORKEXPERIENCE" name="QUALIFICATION_WORKEXPERIENCE" placeholder="Work Experience"   autocomplete="none"></textarea> 
                      </div>
                    </div>
                  </div> 
