...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>ServiceXpert</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ServiceXpert</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'serviceman') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/serviceman/">
            <i class="fa fa-building"></i> <span>Add Serviceman</span> 
          </a>
        </li>
        <li class="<?php echo (currentpage() == 'services') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/services/">
            <i class="fa fa-suitcase"></i> <span>  Add Services</span> 
          </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">ServiceXpert</a>.</strong> All rights
    reserved.
  </footer>
