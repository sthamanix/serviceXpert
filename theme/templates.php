...
<head>
<meta charset="utf-8">
<title>ServiceXpert  <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+977) 9860672511</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">ServiceXpert<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="<?php echo web_root; ?>index.php">Home</a></li> 
                        <!-- <li><a href="<?php echo web_root; ?>index.php?q=search-function">Services</a></li> -->
                        <!-- <li class="dropdown">
                          ...
                          <ul class="dropdown-menu"> -->
                             ...
                             <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='advancesearch'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=advancesearch">Services</a></li> 
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>ServiceXpert</strong><br>
          Thankot, Kathmandu<br>
           Pin-44600 Nepal.</address>
          <p>
            <i class="icon-phone"></i> (+977) 9860672511  <br>
            <i class="icon-envelope-alt"></i> ServiceXpert@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            ...
            <li><a href="<?php echo web_root; ?>index.php?q=company">Services</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; ServiceXpert 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
