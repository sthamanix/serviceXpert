...
function doInsert($jobid = 0, $fileid = 0)
{
    if (isset($_POST['submit'])) {
        ...
        if ($age < 20) {
            ...
            message("You have booked service.Please wait until Serviceman will approve/reject it. ", "success");
...
function doRegister()
{
    ...
    if (isset($_POST['btnRegister'])) {
        ...
        if ($age < 20) {
            ...
            message("You have successfully registered on the site. You can now log in!", "success");
...
function doLogin()
{
    ...
    if ($res == true) {
        ...
        echo "Account does not exist! Please contact the administrator.";
    }
}

function UploadImage($jobid = 0)
{
    $target_dir = "admin/applicants/photos/";
